...
class TwoLayerNet(object):
    ...
    def loss(self, X, y):
        ...
        h = layer1.feedforward(X)
        o = layer2.feedforward(h)
        ...
        dout = softmax_loss(o,y)[1]
        dout2 = layer2.backward(dout)
        dx = layer1.backward(dout2)
    ...
    def step(self, learning_rate=1e-5, optim='SGD', momentum=0.5):
        ...
        params = layer1.params + layer2.params        # list + list is a longer list !!
    ...
    def predict(self, X):
        ...
        x = layer2.feedforward(layer1.feedforward(X))
