...
class DenseLayer(FullyConnectedLayer):
    ...
    def feedforward(self, X):
        ...
        from utils.layer_funcs import affine_forward, relu_forward
    ...
    def backward(self, dout):
        ...
        from utils.layer_funcs import affine_backward, relu_backward
        
        # 
        # print("122", dout.shape, relu_forward(A).shape ) # 122 (100, 20) (100, 100)
        
        dout1 = relu_backward(dout, relu_forward(A)) # notice A!!
        
        dX,dW,db = affine_backward(dout1,X,W,b)
        
        # db = affine_backward(dout1,X,W,b)[2]      
        ################################################
        #           END OF YOUR CODE                   #
        ################################################
