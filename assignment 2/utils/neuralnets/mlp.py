    ...
    def loss(self, X, y):
        ...
        for i in range(num_layers - 1):
            ...
            if use_bn:
                ...
                bn_params_layer_i = bn_params[i]
                cache_name = "bn_{}".format(i)
                x, cache[cache_name] = bn_forward(x, gamma, beta, bn_params_layer_i, mode = "train")
                # return cache from bn_forward has form:
        ...
        for i in range(num_layers - 1):
            ...
            #  dropout_backward(dx,cache) return dx
            ...
            if use_bn:
                ...
                # bn_backward return: dx, dgamma, dbeta
    ...
    def predict(self, X):
        ...
        for i in range(num_layers - 1):
            ...
            if use_bn:
                ...
                beta = params["bn_beta_{}".format(i)]
                bn_params_layer_i = bn_params[i]
                x, _ = bn_forward(x, gamma, beta, bn_params_layer_i, mode = "test")
            ...
            x,_ = dropout_forward(x,dropout_config,mode = "test")
