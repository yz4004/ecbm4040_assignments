...
class LeNet(Model):
    ...
    def __init__(self, input_shape, output_size=25):
        ...
        # print('./utils/neuralnets/cnn/my_model_LeNet.__init__() not implemented!') # delete me
        ...
        self.conv_layer_2 = Conv2D(filters=16, kernel_size=(5, 5), strides=(1,1), activation='tanh', input_shape=input_shape, padding="same")
    ...
    def call(self, x):
        ...
        # print('./utils/neuralnets/cnn/my_model_LeNet.call() not implemented!') # delete me
